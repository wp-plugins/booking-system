...
* Description             : Booking System database PHP class. IMPORTANT! Version, configuration, initialization, initial data, update,  need to be in same file because of issues with instalation/update via FTP.
*/
...
// Database
            ...
            function init(){
                ...
                $old_db_version = get_option('DOPBS_db_version');
                
                if ($this->db_version != (float)$current_db_version || (isset($old_db_version) && !isset($current_db_version))){
...
// Update
            ...
            function update(){
                ...
                if (isset($old_db_version)
                        && (!isset($current_db_version) || $current_db_version == '')){
