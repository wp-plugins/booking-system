...
* Ability to change currency (all known currencies are supported)
...
Click [here](http://help.dotonpaper.net/booking-system-wordpress-plugin.html) to view documentation.
