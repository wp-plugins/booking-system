...
* Description             : Booking System back end reservations views class.
*/
 ...
 */
            ...
            function listCalendars(){
                 ...
                 */
                array_push($calendars_ids, 1);
                array_push($html, '<option value="1" selected="selected">ID: 1 - '.$calendar->name.'</option>');
